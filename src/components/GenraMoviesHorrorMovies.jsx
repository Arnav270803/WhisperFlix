...
const GenraMoviesHorrorMovies = () => {
  const navigate = useNavigate();

  // Horror movies data
  const horrorMovies = [
    { 
      id: 1, src: assets.incantation, title: "Incantation", rating: "6.2", year: "2022",
      description: "A mother breaks a curse after filming a forbidden ritual, saving her daughter.",
      platforms: ["Netflix", "Amazon Prime"],
      trailer: "https://www.youtube.com/watch?v=HnyNZdcL_GY"
    },
    { 
      id: 2, src: assets.fairStreet, title: "The Conjuring", rating: "6.2", year: "2021",
      description: "Teens uncover a cursed town’s dark history, facing supernatural killers in 1994.",
      platforms: ["Netflix"],
      trailer: "https://www.youtube.com/watch?v=UyUuzCGblqc"
    },
    { 
      id: 3, src: assets.nightHouse, title: "The Night house", rating: "6.4", year: "2020",
      description: "A widow uncovers her late husband’s dark secrets in their lake house.",
      platforms: ["Hulu", "Amazom Prime"],
      trailer: "https://www.youtube.com/watch?v=W8WQGXkif_s"
    },
        { 
          id: 4, src: assets.lighthouse, title: "The Lighthouse", rating: "7.4", year: "2019",
          description: "Two lighthouse keepers descend into madness on a remote, storm-battered island.",
          platforms: ["Amazon Prime", "Hulu"],
          trailer: "Hyag7lR8CPA"
        },
    { 
      id: 5, src: assets.theinvitation, title: "The Invitation", rating: "5.3", year: "2022",
      description: "A man uncovers a horrifying conspiracy at his girlfriend’s family estate.",
      platforms: ["Amazon Prime","Netflix"],
      trailer: "https://www.youtube.com/watch?v=5bL1ftuxgOE"
    },
    { 
      id: 6, src: assets.thetakingofdeborahlogan, title: "The Taking of Deborah Logan", rating: "6.0", year: "2014",
      description: "A film crew documents an elderly woman's Alzheimer's, uncovering sinister forces.",
      platforms: ["Netflix"],
      trailer: "https://www.youtube.com/watch?v=DnZNojsjlQM"
    },
    { 
      id: 7, src: assets.themedium, title: "The Medium", rating: "6.5", year: "2021",
      ...
      <div className="relative z-10 pt-8 pb-12">
        ...
        <div className="text-center">
          ...
          <p className="text-white/80 text-lg md:text-xl font-light tracking-wide">
            Spine-chilling films that will keep you on the edge
          </p>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm px-3 py-1 rounded-full border border-orange-400/30">
                    <span className="text-orange-400 text-sm font-medium">{movie.year}</span>
                  </div>
                </div>
...
export default GenraMoviesHorrorMovies;