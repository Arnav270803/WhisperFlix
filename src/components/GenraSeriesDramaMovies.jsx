...
const GenraSeriesDramaMovies = () => {
  const navigate = useNavigate();

  // Drama series data
  const dramaSeries = [
    { 
      id: 1, src: assets.labrea, title: "La Brea", rating: "5.8", year: "2021-2024",
      description: "A sinkhole in Los Angeles traps a family in a primeval world, seeking answers.",
    ...
    { 
      id: 3, src: assets.queensgambit, title: "Queens gambit", rating: "8.5", year: "2020",
    ...
    { 
      id: 4, src: assets.theterror, title: "The Terror", rating: "7.8", year: "2018",
      ...
      <div className="relative z-10 pt-8 pb-12">
        ...
        <div className="text-center">
          ...
          <p className="text-white/80 text-lg md:text-xl font-light tracking-wide">
            Emotional series that tug at your heartstrings
          </p>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm px-3 py-1 rounded-full border border-green-400/30">
                    <span className="text-green-400 text-sm font-medium">{series.year}</span>
                  </div>
                </div>
...
export default GenraSeriesDramaMovies;