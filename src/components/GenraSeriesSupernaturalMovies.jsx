...
const GenraSeriesSuperNaturalMovies = () => {
  const navigate = useNavigate();

  // Supernatural series data
  const supernaturalSeries = [
    { 
      id: 1, src: assets.fallingskies, title: "Falling Skies", rating: "7.1", year: "2011",
      description: "After a devastating alien invasion, survivors form a resistance; led by a history professor turned leader.",
      platforms: ["Amazon Prime" , "HBO Max"],
      trailer: "https://www.youtube.com/watch?v=SjroVVhe8G0"
    },
    { 
      id: 2, src: assets.hemlockgrove, title: "Hemlock Grove", rating: "7.0", year: "2013",
      description: "A wealthy heir and a Romani werewolf in a small town investigate brutal murders and dark, supernatural secrets.",
      platforms: ["Netflix", "Prime Video"],
      trailer: "https://www.youtube.com/watch?v=cFWa0siiVb8"
    },
    { 
      id: 3, src: assets.nightHouse, title: "American Horror Story", rating: "8.0", year: "2011",
      description: "An anthology of terrifying tales with supernatural twists.",
      platforms: ["Netflix"],
      trailer: "https://www.youtube.com/watch?v=2Tshycci2ZA"
    },
    { 
      id: 4, src: assets.jericho, title: "Jericho", rating: "7.9", year: "2006",
      description: "A small Kansas town struggles to survive and rebuild after a nuclear attack destroys major American cities",
      platforms: ["Amazon Prime","Apple TV"],
      trailer: "https://www.youtube.com/watch?v=LAZOyEp6lng"
    },
      ...
      <div className="relative z-10 pt-8 pb-12">
        ...
        <div className="text-center">
          ...
          <p className="text-white/80 text-lg md:text-xl font-light tracking-wide">
            Otherworldly series that defy reality
          </p>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm px-3 py-1 rounded-full border border-pink-400/30">
                    <span className="text-pink-400 text-sm font-medium">{series.year}</span>
                  </div>
                </div>
...
export default GenraSeriesSuperNaturalMovies;