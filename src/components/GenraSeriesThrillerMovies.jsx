...
const GenraSeriesThrillerMovies = () => {
  const navigate = useNavigate();

  // Thriller series data
  ...
  { 
   ...
   { 
        id: 2, src: assets.midnightclub, title: "The Night House", rating: "6.5", year: "2022",
     ...
     { 
        id: 3, src: assets.midnightmass, title: "Midnight Mass", rating: "7.7", year: "2021",
    ...
    { 
      id: 4, src: assets.supernatural, title: "Super Natural", rating: "8.4", year: "2005",
      description: "Two brothers traverse the U.S., hunting monsters, demons, and other supernatural threats while battling personal and cosmic destinies.",
  ...
  const platformLogos = {
    ...
    "Showtime": "https://logos-world.net/wp-content/uploads/2021/08/Showtime-Logo.png",
    "BBC iPlayer": "https://logos-world.net/wp-content/uploads/2021/08/BBC-iPlayer-Logo.png"
  };
    ...
    <div className="relative min-h-screen w-screen text-white overflow-x-hidden">
      ...
      <div className="relative z-10 pt-8 pb-12">
        ...
        <div className="text-center">
          <h1 className="bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-400 bg-clip-text text-transparent text-6xl md:text-7xl font-bold font-movie-title tracking-wider mb-4">
            THRILLER SERIES
          </h1>
          <p className="text-white/80 text-lg md:text-xl font-light tracking-wide">
            Suspenseful series that will keep you guessing
          </p>
          
          {/* Decorative line */}
          <div className="mx-auto mt-4 h-1 w-48 bg-gradient-to-r from-purple-500 to-blue-400 rounded-full"></div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {thrillerSeries.map((series) => (
              <div
                key={series.id}
                className="movie-card group relative bg-gradient-to-br from-black/60 to-gray-900/60 backdrop-blur-md rounded-2xl overflow-hidden border border-purple-400/20 shadow-2xl hover:shadow-purple-500/30 hover:scale-110 hover:border-purple-400/60 transition-all duration-500 hover:backdrop-blur-xl hover:bg-gradient-to-br hover:from-black/80 hover:to-gray-900/80 hover:z-50"
                onMouseEnter={(e) => {
                  // Blur background
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <div className="w-16 h-16 bg-purple-600/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-2xl">
                  ...
                  <div className="absolute top-4 right-4 bg-purple-500/90 backdrop-blur-sm px-2 py-1 rounded-full flex items-center gap-1">
                    <img 
                  ...
                  {/* Year Badge */}
                  <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm px-3 py-1 rounded-full border border-purple-400/30">
                    <span className="text-purple-400 text-sm font-medium">{series.year}</span>
                  </div>
                </div>
                ...
                <div className="p-6 relative">
                  {/* Title */}
                  <h3 className="text-xl font-bold bg-gradient-to-r from-purple-400 to-blue-300 bg-clip-text text-transparent mb-3 group-hover:from-purple-300 group-hover:to-blue-200 transition-all duration-300">
                    {series.title}
                  </h3>
                  ...
                  <button 
                    onClick={() => window.open(series.trailer, '_blank')}
                    className="w-full py-2 px-3 bg-gradient-to-r from-purple-500/20 to-blue-500/20 backdrop-blur-sm border border-purple-400/50 text-purple-400 font-medium text-sm rounded-lg hover:from-purple-500/40 hover:to-blue-500/40 hover:border-purple-300 hover:text-purple-200 hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300 relative overflow-hidden group-button"
                  >
                    ...
                    {/* Button glow effect */}
                    <div className="absolute inset-0 bg-gradient-to-r from-purple-400/0 via-purple-400/20 to-purple-400/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-in-out"></div>
                  </button>

                  {/* Enhanced glow effect for entire card */}
                  <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-gradient-to-r from-purple-500 via-blue-500 to-purple-500 blur-2xl -z-10 animate-pulse"></div>
                </div>

                {/* Subtle glow effect */}
                <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-300 bg-gradient-to-r from-purple-500 to-blue-500 blur-xl -z-10"></div>
              </div>
            ))}
          </div>
        </div>
...
export default GenraSeriesThrillerMovies;